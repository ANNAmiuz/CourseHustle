...
class Student:
    ...
    def selectTerm(self):
        self.term = 'e0ae6c609db740e9909ca83fe5daa748'
        terms = self.getTerm()
        print("Index\tName\n")
    ...
    def queryRecommended(self, keyword, require_not_full=False, require_no_conflict=False,
        studentid="2019302160216",batch = "e0ae6c609db740e9909ca83fe5daa748",
        class_type = "TJKC"):
        checkCapacity = "2"
        checkConflict = "2"
        if require_not_full:
    ...
    def selectSingleCourse(self, rsection):
        ...
        while success == 0:
            params = {"data": {"operationType": "1", "studentCode": studentCode, "electiveBatchCode": electiveBatchCode,
                            "teachingClassId": teachingClassId, "isMajor":isMajor , "campus": "11", "teachingClassType": "TJKC"}}
            # print(addParam)
    ...
    def manual_search(self, keyw):
        ...
        studentid=self.studentid,batch = self.term,class_type = "TJKC")
...
student = Student()
student.single_interval = 10
student.mul_interval = 200
student.selectTerm()
